      ...
      $('#profile').html(`
         ...
         <a href="${user.html_url}" target="_blank" class="btn btn-dark btn-lg btn-block">View Profile</a>
          <br /><br />
              ...
              <span class="label label-primary"><strong>Public Gists:</strong> ${user.public_gists}</span>
              <span class="label label-success"><strong>Followers:</strong> ${user.followers}</span>
              <span class="label label-info"><strong>Following:</strong> ${user.following}</span>
              <br><br>
              <ul class="list-group">
